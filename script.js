      ...
      while (count < 10) {
        html += `<div class="card">
                    <div class="image-container">
                        <img src="${searchResults[count].images.preview_gif.url}" alt="${searchResults[count].title}" />
                    </div>
                    <h2 class="display-name">${searchResults[count].user? searchResults[count].user.display_name : ""}</h2>
                    <p class="caption">${searchResults[count].user? searchResults[count].user.description : ""}</p>
                </div>`;
        count++;
      }
